...
const WalletPage: React.FC = () => {
  ...
  if (loading || !wallet) return <div className="p-8 text-center">Loading wallet...</div>;
  ...
  return (
    <div className="p-4 max-w-2xl mx-auto space-y-6 pb-24">
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-800 rounded-2xl p-6 text-white shadow-lg">
        ...
        <div className="flex gap-4 border-t border-green-500/30 pt-4 mt-2">
           <div>
           ...
           <div className="border-l border-green-500/30 pl-4">
             <p className="text-green-200 text-xs">Pending Clearance</p>
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none"
              placeholder="0.00"
            />
          </div>
          <button 
